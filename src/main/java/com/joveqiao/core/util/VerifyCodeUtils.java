...
public class VerifyCodeUtils {
	 ...
	 * @throws IOException
	 */
	public static void getVerifyCode(HttpServletRequest request, HttpServletResponse response, int imgsize, int width,
	...
	public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
		...
		Color[] colorSpaces = new Color[] { new Color(32, 39, 120), new Color(26, 86, 97), new Color(23, 106, 88) };
		...
		Paint linearPaint2 = new LinearGradientPaint(0, 0, w, h, new float[] { 0.3f, .6f, .8f, .9f }, new Color[] {
				new Color(245, 197, 0), new Color(228, 118, 21), new Color(221, 74, 22), new Color(240, 233, 39) });
		// 设置图片背景为白色
