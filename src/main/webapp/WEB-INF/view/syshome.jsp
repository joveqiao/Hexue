	...
	<div class="indextop">
		<div class="logo">
			<%-- <a href="/emcheckin/welcome.aspx" target="main" title="学霸网系统管理后台"><img
				src="<%=request.getContextPath() %>/resources/images/logo.gif" /></a> --%>
		</div>
		<div class="right">
			...
			<div class="login">
				<div class="login1">
					<ul class="help">
						<li><img src="<%=request.getContextPath() %>/resources/images/help.gif" style="vertical-align: middle" />
							<a href="">帮助</a></li>
						<li><a href="4">关于</a></li>
		...
		<div id="Content">
			<div id="ifmain" class="main_right">
				<iframe id="main" name="main" frameborder="0" scrolling="yes"
					width="100%" height="98%" src="<%=request.getContextPath() %>/site/welcome"></iframe>
			</div>
		</div>
	</div>
</body>
